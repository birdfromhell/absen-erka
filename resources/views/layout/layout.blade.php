    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a class="navbar-brand">
                ...
                <!--logo End-->
                <h4 class="logo-title">ERKA Solution</h4>
            </a>
                            ...
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a class="btn btn-link btn-soft-light">
                                        ...
                                        <p id="time-display" class="large-time"></p>
                                    </a>
                                </div>
                            </div>
                        </div>
...
<script>
    function updateClock() {
        ...
        // Menampilkan waktu sekarang dalam format HH:MM:SS
        const formattedTime =
    ...
    // Panggil fungsi untuk pertama kali agar waktu muncul langsung saat halaman dimuat
    updateClock();
</script>
